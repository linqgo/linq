...
func TestRandomSample(t *testing.T) {
	...
	assertQueryEqual(t, []int{2, 3, 4, 5}, linq.Iota1(10).SampleSeed(0.6, 0))
	assertQueryEqual(t, []int{2, 3, 4}, linq.Iota1(10).SampleSeed(0.6, 0).Take(3))
	assertQueryEqual(t, []int{0, 4, 5, 7, 8, 9, 11, 17}, linq.Iota1(20).SampleSeed(0.3, 1234))
